# Role Assignment for Function App (Storage Blob Data Contributor)
...
# Role Assignment for Function App (Contributor)
...
# Role Assignment for Function App (Key Vault Secrets User)
...
# Role Assignment for Logic App (Storage Queue Data Contributor)
...
# Entra Role for Logic App (Directory Reader)
